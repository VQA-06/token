...
import { printReceipt, connectPrinter } from './bluetooth';
...
printBtn.addEventListener('click', async () => {
  ...
  try {
    const storeName = localStorage.getItem('storeName') || 'SA CELL';
    await printReceipt({ ...currentReceiptData, storeName });
    showToast('Berhasil mencetak struk!');
  } catch (err) {
    showToast('Gagal mencetak: ' + err.message);
  } finally {
